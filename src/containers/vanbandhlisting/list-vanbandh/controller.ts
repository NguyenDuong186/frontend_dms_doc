...
export function UseDHListController() {
  const state = useAppSelector((state: RootState) => state.dataDH)
  ...
  const getAllData = async () => {
    ...
    const params = { phan_nhom_van_ban: 'DH' }
